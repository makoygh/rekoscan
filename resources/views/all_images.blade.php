    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                                ...
                                                <tbody>
                                                    @foreach ($uploadedImages as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('view.image', $item->id) }}"
                                                                    class="btn btn-inverse-warning">View Facial Analysis
                                                                    and News</a>
            ...
            <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                Developed by Team RekoScan | Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP
                v{{ PHP_VERSION }})
            </footer>
